...
{
	if(strstr((const char *)USART3_ReceiveBuffer,StringEnroll) != NULL)
	{
		printf("\r\n————注册指纹模式————\r\n");
	...
	else if(strstr((const char *)USART3_ReceiveBuffer,StringDelete) != NULL)
	{
		printf("\r\n————删除指纹模式————\r\n");
	...
	else if(strstr((const char *)USART3_ReceiveBuffer,StringEmpty) != NULL)
	{
		printf("\r\n————清空指纹模式————\r\n");
